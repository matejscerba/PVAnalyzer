...
\def\NazevPrace{Analýza videozáznamu skoku o~tyči}

% Název práce v angličtině
\def\NazevPraceEN{Analysis of pole-vault video recording}

% Jméno autora
\def\AutorPrace{Matěj Ščerba}
...
\def\Vedouci{Ing. Michal Bartoš, Ph.D.}
...
\def\KlicovaSlova{%
{skok o~tyči} {detekce pozice těla} {videozáznam}
}
\def\KlicovaSlovaEN{%
{pole vault} {human pose detection} {video recording}
}
